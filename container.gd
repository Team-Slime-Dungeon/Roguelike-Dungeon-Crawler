...
func set_container(type="Chest"):
	...
	if type == "Chest":
		...
		monster_type = "Crate"
		# Drops are coin, shuriken, weapons, armor or treasure
		monster_drops = [0,30,30,49,50,51]
		...
		monster_type = "Vase"
		# Drops are: Coins, Shuriken, Mushrooms
		monster_drops = [0,0,30,30,71]
